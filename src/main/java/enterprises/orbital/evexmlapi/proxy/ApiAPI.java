...
public class ApiAPI extends AbstractAPIEndpoint {
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "EVE Online API call list", response = ICallList.class),
  ...
  @ApiImplicitParams(@ApiImplicitParam(
      ...
      dataType = "string",
      paramType = "query"))
  public Response requestCallList(@Context HttpServletRequest req, @Context UriInfo info) {
